			...
			<aside className='menu'>
				...
				<div className={`nav-collapse ${this.state.navExpanded ? 'expanded' : 'collapsed'}`}>
					...
					<ul className='menu-list'>
						...
						<NavItem link={`/manage/${params.id}/modules`} icon='modules' label='Modules' classes='tab-control' onClick={this.toggleNavigation} />
						<NavItem link={`/manage/${params.id}/commands`} icon='commands' label='Commands' classes='tab-control' onClick={this.toggleNavigation} />
						<NavItem link={`/manage/${params.id}/music/queue`} icon='music' label='Music Queue' classes='queue-control' onClick={this.toggleNavigation} />
						...
						<NavItem link={`/manage/${params.id}/server-listing`} icon='server-info' label='Server Info' className='last' classes='tab-control' onClick={this.toggleNavigation} />
