...
export default class Cluster extends React.Component {
  ...
  render() {
    ...
    return (<div><div onClick={(ev) => { ReactTooltip.show(ev.target) }} data-tip data-for={`clusterStatus${clusterId}`} className={`cluster bg-${color}${highlight}`}>{clusterId}</div><ReactTooltip id={`clusterStatus${clusterId}`} type={color === 'danger' ? 'error' : color} effect='solid'>
