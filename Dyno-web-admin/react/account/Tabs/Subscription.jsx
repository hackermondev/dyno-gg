                            ...
                            <div className={'active-subscriptions'}>
                                ...
                                {dynoPremiumSubscriptions.map((sub, i) => (<div key={i} className={'active-subscription'}>
                                    <div className={'subscription-header'}>
                                        <div className={'title is-5 with-image'}><img alt="Orange diamond shaped Dyno logo with transparent background" className="image is-32x32" src={'https://premium.dyno.gg/images/premium-transparent.png'} /> Dyno {sub.name || sub.planObject.name}</div>
