...
class CommandHandler extends Module {
	...
	commandEnabled(e, command) {
		...
		if (commandOpts.ignoredChannels && commandOpts.ignoredChannels.includes(message.channel.id)) {
			return false;
		}
		...
		if (commandOpts.allowedChannels && commandOpts.allowedChannels.includes(message.channel.id)) {
			hasPermissions = true;
		}
		...
		if (commandOpts.allowedChannels && commandOpts.allowedChannels.length && !commandOpts.allowedChannels.includes(message.channel.id)) {
			hasPermissions = false;
		}
