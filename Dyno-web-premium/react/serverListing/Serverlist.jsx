            ...
            <div>
                <div className="container serverlist">
                    ...
                    {this.props.isMainPage &&
                        <img className="home-logo" alt="White diamond shaped Dyno logo" src="https://s.dyno.gg/web-assets/landing/logo.png" />
                    }
                    <div className="columns is-multiline search-container">
                        ...
                        <div className="column is-half sort-column">
                            {sortSelect}
                        </div>
                        <div className="column is-half category-column">
                            {!this.props.isMainPage &&
