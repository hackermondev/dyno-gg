...
export default class Account extends React.Component {
	...
	async getData() {
		try {
			...
			let userDataRequest = await axios.get(`/staff/account/data${urlSuffix}`);
	...
	refundTransaction = async (id) => {
		try {
			await axios.post(`/account/transactions/${id}/refund`);
			this.getData();
		} catch (e) {
			this.setState({ error: 'Failed to refund subscription, try again later' });
		}
	}
		...
		return (
			<div className='container'>
				<Premium {...this.state}
					...
					refundTransaction={this.refundTransaction.bind(this)} />
